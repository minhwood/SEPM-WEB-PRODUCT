  ...
  <body class="bg-light" id="top">
    <div class="container">
      <div class="py-5 text-center">
        <!-- <a href='index.php'><img class="d-block mx-auto mb-4" src="img/logo.jpg" alt="Company Logo in PNG" height="105"></a> -->
        ...
        foreach ($_SESSION['cart'] as $key => $value) 
        {
            ...
            " <li class='list-group-item d-flex justify-content-between lh-condensed'>
              <div>
                ...
                <small class='text-muted'>Quantity: $value->no</small>
              </div>
        ...
        <div class="col-md-8 order-md-1">
          ...
          <form class="needs-validation" novalidate>
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-3 has-error">
                <label for="cc-number">Credit card number</label>
                <input type="text" class="form-control credit-card-input" id="cc-number" placeholder="" required>
                <div class="invalid-feedback">
